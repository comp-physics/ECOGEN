...
void APKViscosity::communicationsAddPhys(const TypeMeshContainer<Cell *> &cells, const int &dim)
{
...
void APKViscosity::communicationsAddPhysAMR(const TypeMeshContainer<Cell *> &cells, const int &dim, const int &lvl)
{
