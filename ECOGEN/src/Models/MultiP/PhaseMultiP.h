...
#ifndef PHASEMULTIP_H
#define PHASEMULTIP_H
...
//! \class     PhaseMultiP
//! \brief     Phase variables for MultiP system of equations (mechanical equilibrium)
class PhaseMultiP : public Phase
{
  public:
    PhaseMultiP();
    ...
    PhaseMultiP(tinyxml2::XMLElement *material, Eos *eos, std::string fileName);
    virtual ~PhaseMultiP();
