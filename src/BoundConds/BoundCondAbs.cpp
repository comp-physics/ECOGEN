...
void BoundCondAbs::creeLimite(TypeMeshContainer<CellInterface *> &cellInterfaces)
{
  cellInterfaces.push_back(new BoundCondAbs(*(this)));
}
...
void BoundCondAbs::creerCellInterfaceChild()
{
  m_cellInterfacesChildren.push_back(new BoundCondAbs(*this, m_lvl + 1));
}
